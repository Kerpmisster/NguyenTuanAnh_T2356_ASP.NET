...
namespace Lab07.Areas.Admins.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Address,Avatar,BirthDay,Gender,Password,Facebook")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Address,Avatar,BirthDay,Gender,Password,Facebook")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
