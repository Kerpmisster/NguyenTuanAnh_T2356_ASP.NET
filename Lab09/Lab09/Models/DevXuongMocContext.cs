...
//        => optionsBuilder.UseSqlServer("Server=LAPTOP-SSHUBNQA\\SQLEXPRESS;Database=DevXuongMoc;uid=sa;pwd=123456;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C8821D77EAC3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC274FA1D4EB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC27CA6F41F5");
